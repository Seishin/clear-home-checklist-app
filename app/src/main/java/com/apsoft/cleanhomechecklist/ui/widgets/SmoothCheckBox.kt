...
class SmoothCheckBox : View, Checkable {
    ...
    private fun init(attrs: AttributeSet) {
        ...
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.SmoothCheckBox_stroke_width, CompatUtils.dp2px(context, 0))
        ta.recycle()
    ...
    override fun onRestoreInstanceState(state: Parcelable) {
        if (state is Bundle) {
            ...
            super.onRestoreInstanceState(bundle.getParcelable<Parcelable>(KEY_INSTANCE_STATE))
            return
        }
